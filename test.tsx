        ...
        <Card className="absolute top-full left-1/2 -translate-x-1/2 z-20 py-3 px-4 text-sm tracking-wider w-[20rem] max-h-[32rem] overflow-y-auto">
            ...
            <div className="mb-4">
                ...
                <select 
                    ...
                    onChange={(e) => setSettings({...settings, contractType: e.target.value})}
                >
            ...
            <div className="mb-4">
                ...
                <select 
                    ...
                    onChange={(e) => setSettings({...settings, anchorVersion: e.target.value})}
                >
            ...
            <div className="mb-3">
                <label className="flex items-center cursor-pointer">
                    <input 
                        ...
                        onChange={(e) => setSettings({...settings, includeClient: e.target.checked})}
                        className="mr-2"
                    />
            ...
            <div className="mb-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                    ...
                    {settings.securityLevel === 'standard' && 'Access control + error handling'}
