...
## FILE GENERATION
- before generating a file it should write it's name with path in <file>programs/[pragram_name]/src/[path].[extension]</file>
- before generating the actual code of a file it should be wrapped inside ```[language] --- code --- ```[language]
