...
export default function Hero() {
    ...
    return (
        <main className="relative flex flex-col justify-between items-center h-screen w-full bg-dark-base rounded-[8px] overflow-hidden mt-9 ">
            ...
            <div
                className={`w-full flex fixed justify-center items-start pt-2 z-20 px-5 transition-all duration-300 ${
                    scrolled ? 'backdrop-blur-xs -translate-y-10' : ''
                }`}
            >
                <Navbar />
            </div>
