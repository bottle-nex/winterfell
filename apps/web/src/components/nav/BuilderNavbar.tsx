...
import {
  CurrentView,
  useCurrentViewStore,
} from "@/src/store/project/useCurrentViewStore";
        ...
        <div className="flex items-center justify-start bg-neutral-800 rounded-lg p-[3px] border border-neutral-600">
          ...
          >
            <FaPlay
              ...
              className={cn(
                ...
                currentView === CurrentView.PREVIEW &&
                  "text-[#2b96e3] bg-primary/30",
              )}
              onClick={() => setCurrentView(CurrentView.PREVIEW)}
            />
          </ToolTipComponent>
          <ToolTipComponent
            side="bottom"
          ...
          >
            <FaCode
              ...
              onClick={() => setCurrentView(CurrentView.EDITOR)}
            />
          </ToolTipComponent>
        </div>
