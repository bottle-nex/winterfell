...
export const exportingSteps: Step[] = [
        {
            ...
            description: 'Watch your smart contract files get created in real-time as the AI generates your code.',
        },
        {
            number: 2,
            ...
            description: (
                <div className="flex flex-col gap-y-3">
                    <p className="text-light/70 text-sm">Authenticate with GitHub to enable seamless repository exports</p>
            ...
            description: (
                <div className="flex flex-col gap-y-3">
                    <div className="bg-[#1a7f37]/10 border border-[#1a7f37]/40 rounded-[4px] px-4 py-3 flex items-start gap-x-3">
                        <svg className="w-5 h-5 text-[#2da44e] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M13.78 4.22a.75.75 0 010 1.06l-7.25 7.25a.75.75 0 01-1.06 0L2.22 9.28a.75.75 0 011.06-1.06L6 10.94l6.72-6.72a.75.75 0 011.06 0z" />
                        </svg>
                        <div className="flex flex-col gap-y-1">
                            <p className="text-[#2da44e] font-semibold text-sm">Success! Your contract has been exported</p>
                            <p className="text-light/70 text-xs">Your smart contract files are now available in your GitHub repository</p>
                        </div>
                    </div>
                </div>
            ),
